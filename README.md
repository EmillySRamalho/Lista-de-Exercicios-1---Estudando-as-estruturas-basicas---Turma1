...
Após clonar o repositório, você pode abrir os arquivos no Visual Studio Code. Para isso, abra o terminal no local onde o repositório foi clonado e digite o seguinte comando:
[code .] Esse comando abrirá o VS Code na pasta do projeto.

Para executar os arquivos JavaScript, abra o terminal dentro do VS Code e utilize o comando:
